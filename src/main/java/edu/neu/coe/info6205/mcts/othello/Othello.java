...
/**
 * Driver class for a game of Othello.
 */
public class Othello {
	...
	// sets up the game and prompts the user to choose the type of player
	...
	public static void main(String[] args) {
		...
		// get piece of the player that won the game
