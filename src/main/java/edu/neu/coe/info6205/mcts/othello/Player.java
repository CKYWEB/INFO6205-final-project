...
public abstract class Player {
	...
	private final Map<String, List<List<CoordinatePair>>> map = new HashMap<String, List<List<CoordinatePair>>>();
	 ...
	 * 
	 * @param board board state
	 * @param currRow row location of a player's piece on the board
	 * @param currCol column location of a player's piece on the board
	 * @param xOffset which direction in the x coordinate plane should the search go
	 * @param yOffset which direction in the y coordinate plane should the search go
     */
